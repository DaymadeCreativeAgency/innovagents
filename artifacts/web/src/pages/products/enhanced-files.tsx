          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <motion.div
                ...
                className="inline-flex items-center gap-2 bg-accent/[0.12] border border-accent/[0.20] rounded-full px-4 py-1.5 mb-8"
              >
                <span className="text-accent text-[11px] font-semibold uppercase tracking-widest">Salesforce-Native App</span>
              </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <h2 className="text-4xl md:text-5xl text-white mb-4">
              Fix Salesforce file frustrations
            </h2>
          ...
          >
            {FEATURES.map((feature, i) => (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-accent/[0.12] border border-accent/[0.18] flex items-center justify-center mb-5 group-hover:bg-accent/20 transition-colors">
              ...
              <div className="bg-[#0f0e0b] rounded-2xl border border-white/[0.06] overflow-hidden">
                <div className="bg-white/[0.02] px-4 py-3 border-b border-white/[0.06] flex items-center justify-between">
                  <div className="flex gap-2">
                    <div className="w-16 h-7 bg-accent/[0.18] rounded-lg border border-accent/[0.18]" />
                    <div className="w-20 h-7 bg-white/[0.04] rounded-lg border border-white/[0.07]" />
                  </div>
                  <div className="w-32 h-7 bg-white/[0.04] rounded-lg border border-white/[0.07] flex items-center px-2.5 gap-2">
                ...
                <div className="p-4 space-y-2">
                  {[1, 2, 3, 4].map(i => (
                    <div
                      key={i}
                      className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/[0.03] border border-transparent hover:border-white/[0.06] transition-colors"
                    >
                      <div className="w-8 h-8 rounded-lg bg-accent/[0.14] border border-accent/[0.18] flex items-center justify-center flex-shrink-0">
                        <FolderOpen className="w-4 h-4 text-accent" />
                      </div>
                      <div className="flex-1">
                        <div className="h-2.5 bg-white/[0.12] rounded-full w-1/3 mb-1.5" />
                        <div className="h-2 bg-white/[0.06] rounded-full w-1/5" />
                      </div>
                      <div className="w-7 h-7 rounded-lg bg-white/[0.04] border border-white/[0.07]" />
                    </div>
                  ))}
                </div>
              </div>
              ...
              <ul className="space-y-3 mt-2">
                {BENEFITS.map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-white/65 text-sm">
                    <div className="w-4.5 h-4.5 rounded-full bg-accent/[0.15] border border-accent/[0.25] flex items-center justify-center flex-shrink-0">
        ...
        <div className="max-w-6xl mx-auto px-6 max-w-3xl text-center">
          ...
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-7 h-11 text-sm font-semibold bg-accent text-[#1a1410] rounded-full hover:bg-accent/90 transition-colors shadow-sm"
            >
              View on AppExchange
            </a>
            <Link
