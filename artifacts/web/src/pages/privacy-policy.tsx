      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-6 prose prose-neutral prose-headings:font-display prose-headings:font-medium prose-headings:text-[#1a1814] prose-p:text-[#5d574f] prose-li:text-[#5d574f] prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
          ...
          <p>
            ...
            AppExchange. This policy explains how we handle personal information when you visit{" "}
            <a href="https://innovagentsai.com">innovagentsai.com</a>, subscribe to our newsletter, or contact us.
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              <a href="mailto:support@innovagentsai.com">support@innovagentsai.com</a>
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>Send newsletter updates (with your consent; unsubscribe anytime)</li>
          ...
          <ul>
            <li>
              <strong>Consent</strong> — when you subscribe to our newsletter or submit a form
            </li>
            <li>
              <strong>Legitimate interests</strong> — responding to B2B inquiries and improving our services
            </li>
            <li>
          ...
          <p>We do not sell your personal data. We may share it with service providers who help us operate:</p>
          <ul>
            <li>
              <strong>Formspree</strong> — processes contact form submissions
            </li>
            <li>
              <strong>Mailchimp (Intuit)</strong> — manages newsletter subscriptions
            </li>
            <li>
          ...
          <p>These providers process data on our instructions and under appropriate agreements.</p>

          <h2>How long we keep data</h2>
          <p>
            We retain personal data only as long as needed for the purposes above, or as required by law. If you
            unsubscribe, we may keep your email on a suppression list to honor your request.
          </p>
          ...
          <ul>
            ...
            <li>Withdraw consent at any time (for newsletter emails, use the unsubscribe link)</li>
          </ul>
          <p>
            To exercise these rights, email{" "}
            <a href="mailto:support@innovagentsai.com">support@innovagentsai.com</a>. EU/EEA/UK residents may also
            lodge a complaint with their local data protection authority.
          </p>

          <h2>Cookies</h2>
          <p>
            Our site may use cookies and similar technologies for basic functionality, analytics, and marketing
          ...
          <h2>Children</h2>
          <p>
            Our services are intended for business professionals and are not directed to children under 16. We do not
          ...
          <p>
            ...
            <a href="mailto:support@innovagentsai.com">support@innovagentsai.com</a> or visit our{" "}
